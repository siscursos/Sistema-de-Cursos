...
public class CursoDAO {
	...
	public CursoDAO(int codigo, ResourceBundle bun){
    	bn = bun;
    	setCodigo(codigo);
	...
	public CursoDAO(Informatica info, ResourceBundle bun){
	...
	public CursoDAO(Artes at, ResourceBundle bun){
	...
	public CursoDAO consultar(int cod){
		ResultSet rs;
	      try {
