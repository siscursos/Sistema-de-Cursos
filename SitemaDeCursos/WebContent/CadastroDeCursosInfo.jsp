		...
		<div class="row-fluid">
			...
			<div id="content" class="span10" style="background-color: #EFEFEF">
				<ul class="breadcrumb">
					...
					<li><i class="icon-edit"></i>Cadastro de Cursos - Informática</li>
				</ul>
				<div class="container">
					<form method="post" id="fcontato" action="manter_aluno.do">

						<h1>Cadastro de Cursos - Informática</h1>
						...
						<div class="form-group">
							<label for="cNumLab"> Número do Laboratório:</label><input
								type="number" class="form-control" name="tNumLab" id="cNumLab"
								size="4" maxlenght="4" placeholder="Nº Laboratório" />
						</div>
						<div class="form-group">
							<label for="cDescSoft"> Descrição de Software:</label>
